...
contactinfo="VK3 ACN. Victor Kilo 3 Alpha Charlie November... E Mail - S H A Y N E DOT N A S H AT G MAIL DOT COM. The code for this system can be found on git hub as follows. H T T P S COLON SLASH SLASH G I T H U B DOT COM SLASH P E N R E B L SLASH H A M D T M F.  PRESS 7 TO REPEAT"
...
ttwister[7]="The seething sea ceaseth and thus the seething sea sufficeth us."
ttwister[8]="Theophilus Thistler the thistle sifter, In sifting a sieveful of unsifted thistles thrust three thousand Thistles through the thick of his thumb."
